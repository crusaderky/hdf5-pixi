...
```
Same as above, but with ASAN:
```bash
pixi r -e h5py-asan h5py-install
pixi r -e h5py-asan h5py-smoke-test  # Print versions and exit
pixi r -e h5py-asan h5py-pytest  # Run the full pytest suite
```
